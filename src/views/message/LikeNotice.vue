<template>
  ...
  <div class="content__wrapper">
    <el-empty description="还没有任何通知哟~" v-if="!likeNoticeList || !likeNoticeList.length" />
    <div v-for="item in likeNoticeList" :key="item.id" class="notice__item">
      ...
      <div class="notice__wrapper">
        <div class="notice__middle">
          <div>
            ...
            <span class="notice__type" v-if="item.notice.targetEntity.headerImg">赞了你的笔记</span>
    ...
    const getLikeNoticeList = async () => {
      try {
        ...
        if (result.code === 200 && result.data) {
          ...
          likeNoticeList.value = [...result.data]
        } else {
          ElMessage({
            showClose: true,
            message: '发生错误',
